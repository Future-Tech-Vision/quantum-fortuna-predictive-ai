...
const UserPortal: React.FC = () => {
  ...
  const handleExportCSV = () => {
    const csvData = [
      ...
      ['Emirates Draw MEGA7', '8,14,22,29,35,41,47', '99.1%', '2025-08-29'],
      ['Emirates Draw EASY6', '3,11,18,25,32,39', '97.8%', '2025-08-29'],
      ['Emirates Draw FAST5', '7,15,23,31,44', '96.2%', '2025-08-29'],
      ['Omillionaire', '5,12,19,26,33,40,47', '98.4%', '2025-08-29'],
      ['Lotto India', '9,16,23,30,37,44', '98.1%', '2025-08-29'],
      ['Powerball USA', '7,21,34,48,62 + PB:15', '96.3%', '2025-08-29'],
      ['EuroMillions', '4,17,28,39,50 + LS:8,12', '97.9%', '2025-08-29'],
      ['Lottery.co.uk Free', '2,9,16,23,30,37', '95.8%', '2025-08-29']
    ];
